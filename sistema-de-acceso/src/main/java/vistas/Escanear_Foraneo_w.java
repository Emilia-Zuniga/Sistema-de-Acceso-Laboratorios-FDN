...
public class Escanear_Foraneo_w extends javax.swing.JFrame implements Runnable, ThreadFactory {
...
//            codigo = codigo.substring(0, codigo.length()-1);
            ...
            try {
                ...
                String sql1 = "Call Guardar_historial_ingreso_lab1_foraneo ('" + codigo  + "', NULL);";
                ...
                if (pRes == 1) {
                    JOptionPane.showMessageDialog(null, "El alumno cuenta con una visita iniciada. No se puede realizar el registro", "El alumno cuenta con una visita iniciada.", JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                }
                if (pRes == 2) {
