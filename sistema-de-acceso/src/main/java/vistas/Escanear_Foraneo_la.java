...
public class Escanear_Foraneo_la extends javax.swing.JFrame implements Runnable, ThreadFactory {
...
//            codigo = codigo.substring(0, codigo.length()-1);
            ...
            try {
                ...
                String sql1 = "Call Guardar_historial_ingreso_lab2_foraneo ('" + codigo + "', NULL);";
