...
public class Escaner_alumno_la extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        con_codigoA = new EVD1.CustomButtons();
        ...
        con_codigoA.setBackground(new java.awt.Color(51, 51, 51));
        con_codigoA.setForeground(new java.awt.Color(255, 255, 255));
        con_codigoA.setText("CONFIRMAR");
        con_codigoA.setFont(new java.awt.Font("Microsoft New Tai Lue", 1, 14)); // NOI18N
        con_codigoA.setRippleColor(new java.awt.Color(255, 255, 255));
        con_codigoA.setShadowColor(new java.awt.Color(0, 0, 0));
        con_codigoA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                con_codigoAActionPerformed(evt);
            }
        });
        jPanel1.add(con_codigoA, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 380, 120, 40));
    ...
    private void con_codigoAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_con_codigoAActionPerformed
        ...
        if (result_field.getText().equals("")) {
            ...
            try {
                ...
                String sql1 = "Call Guardar_historial_ingreso_lab2 ('" + matricula + "', NULL);";
    ...
    }//GEN-LAST:event_con_codigoAActionPerformed
    ...
    private EVD1.CustomButtons con_codigoA;
